...
public static final String ADD_SUB_CATEGORY_DATA="AddSubCategoryData";
public static final String ADMIN_USER_SEARCH_DATA="AdminUserSearchData";
public static final String EDIT_CATEGORY_TEST_DATA="EditCategoryTestData";
public static final String EDIT_CONTACT_TEST_DATA="EditContactTestData";
public static final String EDIT_NEWS_DATA="EditNewsData";
}
